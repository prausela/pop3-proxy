#ifndef PARSER_FACTORY_H_ACK0Q8X1WrbMI9ZFlPxsr98iOM
#define PARSER_FACTORY_H_ACK0Q8X1WrbMI9ZFlPxsr98iOM
...
struct parser_event *
parser_consume(buffer *b, struct parser *p, bool *errored, bool (*parser_is_done)(const struct parser_event*, bool *));
